...
{
    public class Keyboard : AuraDevice
    {
        internal Keyboard(AuraSDK sdk, IntPtr handle) : base(sdk, handle)
        {
            ledCount = sdk.GetClaymoreKeyboardLedCount(handle);
        }
        ...
        public override void SetColors(Color[] colors)
        {
            ...
            Console.WriteLine(sdk.SetClaymoreKeyboardColor(handle, array, array.Length));
        }
        ...
        public override void SetColors(byte[] colors)
        {
            ...
            Console.WriteLine(sdk.SetClaymoreKeyboardColor(handle, colors, colors.Length));
        }
        ...
        {
            sdk.SetClaymoreKeyboardMode(handle, (int)mode);
        }
    }
}
